...
The main visualisation show that the number of rough sleepers in England appears to have increased within all regions in England from 2010 to 2020. The supporting visualisation indicates that the largest proprtion of rough sleepers in England appear to be in London, and the South of England when taking into account the population of each region. 
