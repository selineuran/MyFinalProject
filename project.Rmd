...
The main visualisation show that the number of rough sleepers in England appears to have increased within all regions in England from 2010 to 2020. In addition, the pie charts seem to indicate that there is an equal prevalence of the number of Rough Sleepers across all regions of England, when taking into account the population of each region. 
