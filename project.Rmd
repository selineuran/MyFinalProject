...
After having removed all sheets from the excel document except for the sheet that contained the total number of rough sleepers I began data preparation. To begin I imported the raw data. 
...
piechart<- bp + coord_polar("y", start=0) + 
    theme_void() +
    ggtitle("Proportion of rough sleepers by Region in England (2020), N = 1974")
