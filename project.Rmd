...
This produced a tibble of the dataset is included below to provide an example of the data in a 'long' (as opposed to a wide) format. 

```{r}
head(rs2_long, 16)
```

I then performed the same steps to prepare the data for the second graph to be visualised; a pie chart of all the rough sleepers in 2020 in each regions of England. 
