...
Graph 2: Number of Rough Sleepers in each Region in England (2019) 
...
```{r, echo=FALSE, message=FALSE, results='hide', fig.show='hold', out.width="50%"}
...
The main visualisation show that the number of rough sleepers in England has increased across all Regions between 2010 - 2020. The pie charts indicate that the number of Rough Sleepers in each Region of England is proportional to the population of the Region. However a future recommendation might be to visualise the Number of Rough Sleepers proportional to population within the same chart. In this way a reliable comparison of the proportional number of Rough Sleepers in each Region could be performed. 
