...
I then prepared the data for the second visualisation. My aim was to create a pie chart of the number of rough sleepers in England by region proportional to population. Data on the population of each region in England has not yet been released as such I visualised the proportional number of rough sleepers in 2019 instead. Therefore, in addition to preparing data on the number of rough sleepers I also imported a further data set  containing the population of each region in England. This could be used to calculate a proportional number of rough sleepers.  
...
Graph 2: Proportion of Rough Sleepers in England by Region (2019) 
...
rspiechart <- bp + coord_polar(theta = "y", start=0) +
  theme_void() +
  ggtitle("Proportion of Rough Sleepers in England by Region (2019)")
